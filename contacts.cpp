...
bool Contact::valid_birthday(const string &birthday) const {
    ...
    if (birthday.length() != 10 || birthday[2] != '-' || birthday[5] != '-') {
        //cout << "Error: Date must be in DD-MM-YYYY format." << endl;
        return false;
    }
    ...
    try {
        ...
        //cout << "Error: Invalid date format. Please use numbers only." << endl;
        return false;
    }
    ...
    if (day > daysInMonth[month - 1]) {
        //cout << "Error: Invalid day for month " << month << "." << endl;
        return false;
    }
    ...
    /*cout << "Checking date: " << day << "-" << month << "-" << year
         << " against current: " << currentDay << "-" << currentMonth << "-" << currentYear << endl;*/

    if (year > currentYear) {
        //cout << "Error: Birth year " << year << " is in the future!" << endl;
        return false;
    }
    if (year == currentYear && month > currentMonth) {
        //cout << "Error: Birth month " << month << " is in the future!" << endl;
        return false;
    }
    if (year == currentYear && month == currentMonth && day > currentDay) {
        //cout << "Error: Birth day " << day << " is in the future!" << endl;
        return false;
    }
